...
export function PersonalFilesView({
  ...
  const visible = sectionRecords.filter((record) => {
    ...
    const matchesStatus = !attentionOnly || ["expired", "alert14", "alert45", "incomplete"].includes(state.level);
